    ...
    <section id="hero" className="container mx-auto px-8">
      <div className="flex flex-col lg:flex-row gap-14 items-center justify-between mt-[80px]">
        <div className="order-2 lg:order-1 text-center lg:text-left mt-16 lg:mt-0">
          ...
          <p className="w-full lg:w-[500px] text-sm lg:text-base mt-4 text-gray-600 dark:text-gray-300">
        ...
        <div className="w-[300px] md:w-[370px] h-[350px] md:h-[428px] bg-orange-100/50 dark:bg-gray-800/50 rounded-3xl relative order-1 lg:order-2">
          ...
          <div className="group icon-img -left-10 bottom-20 rotate-[1.75deg]">
            ...
            <div className="absolute bottom-full mb-2 w-max px-3 py-1.5 bg-gray-800 dark:bg-gray-700 text-white text-xs rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
              React.js
            </div>
          </div>
